      ...
      mainContainerChild={
        <Box sx={{ paddingTop: '6rem', flexGrow: 1, }}>
          ...
          <Box hidden={pageable(2, page)}>
            <Typography>1.1.	PLANEJAMENTO NORMATIVO</Typography>
          ...
          <Box hidden={pageable(3, page)}>
            <Typography>1.2. PLANEJAMENTO	ESTRATÉGICO<br /><br /></Typography>
            <Typography>O Planejamento Estratégico pode ser reconhecido como um modo de planejar que não se reduz à elaboração de um plano de ação, mas considera refletir sobre aspectos organizacionais e variáveis que podem exercer influência interna e externa na execução do plano. Nesse sentido, considera elementos estratégicos presentes na dinâmica organizacional, tendo por objetivo compreendê-los e aprovisionar sua concretização e melhoria (PARENTE, 2011). Esse modelo, ainda, considera as relações entre os atores políticos e instituições como arena de disputa de poder, analisando-as a partir da ótica e equilíbrios de poder (MATUS, 1993).<br /><br />SAIBA MAIS!<br />Para saber mais detalhes sobre o Planejamento Estratégico, indicamos a leitura do seguinte artigo:<br />●	GIOVANELLA. Planejamento estratégico em saúde: uma discussão da abordagem de Mário Testa. Cadernos de Saúde Pública, v. 2, n. 6, 1990.<br />Disponível em: https://www.scielo.br/j/csp/a/y9Jxy9qpphd6YGnMyJRYTyq/?lang=pt</Typography>
            <Stack direction='row'>
              <Button color="error" variant="contained" startIcon={<ArrowBackIcon />}
          ...
          <Box hidden={pageable(4, page)}>
            ...
            <Typography>Fonte: Adaptado de Camargo et al. (2020), Kleba, Krauser e Vendruscolo (2011) e Werneck (2012).</Typography>
            ...
            <Typography>Quadro 02 - Planejamento normativo X Planejamento Estratégico.</Typography>
            <Table>
              <TableHead>
                <TableRow>
            ...
            <Typography>Fonte: Adaptado de Lacerda, Botelho e Colussi (2013) e Santana e Tahana (2008).</Typography>
            <Typography>SAIBA MAIS!<br />Para saber mais detalhes sobre o Planejamento Estratégico Situacional sugerimos a leitura do seguinte texto:<br />●	FERREIRA; SILVA; MIYASHIRO. Planejamento em Saúde. In: GONDIM; CHRISTÓFARO; MIYASHIRO. Técnico de Vigilância em Saúde. Fundamentos. Rio de Janeiro: FIOCRUZ, 2017. p.137-164.<br />Disponível em: https://www.arca.fiocruz.br/handle/icict/39910</Typography>
            <Stack direction='row'>
              <Button color="error" variant="contained" startIcon={<ArrowBackIcon />}
          ...
          <Box hidden={pageable(5, page)}>
            ...
            <Typography>Fonte: GANDIN, 2002.</Typography>
            <Typography>Logo após a discussão desses marcos há o momento do diagnóstico – etapa de geração e análise de dados que irão subsidiar o processo de construção do plano propriamente dito. Com a realização do diagnóstico, passa-se para a discussão e construção participativa do plano ou programação, que deve levar em consideração: os objetivos, as ações a serem desenvolvidas, os recursos necessários, o cronograma, o processo de acompanhamento e a avaliação. E por fim, constrói-se uma agenda com a contribuição de todos os atores sociais envolvidos no processo de promoção da saúde (PARENTE, 2011).</Typography>
            <Typography>SAIBA MAIS!<br />Para conhecer melhor o Planejamento Participativo indicamos a leitura do seguinte artigo:<br />●	PARENTE. Planejamento participativo em saúde. SANARE, v. 10, n. 1, 2011.<br />Disponível em: https://sanare.emnuvens.com.br/sanare/article/view/144</Typography>
            <Stack direction='row'>
              <Button color="error" variant="contained" startIcon={<ArrowBackIcon />}
          ...
          <Box hidden={pageable(7, page)}>
            <Typography>3. MARCOS LEGAIS E NORMATIVOS E INSTRUMENTOS DE PLANEJAMENTO EM SAÚDE</Typography>
            <Typography>No âmbito do Sistema Único de Saúde, diversos marcos legais e normativos abordam aspectos relacionados ao planejamento e seus instrumentos (Quadro 05). Nesse cenário, proporcionar o adequado planejamento das diretrizes, objetivos, metas e ações de saúde nas diferentes esferas de gestão do SUS leva à necessidade de constituir alguns instrumentos de planejamento que devem, por sua vez, se interligar sequencialmente e ciclicamente (CONASEMS, 2021).</Typography>
            <Typography>Quadro 05 - Marcos legais e normativos que abordam aspectos relacionados ao planejamento no SUS.</Typography>
            <Table>
              <TableHead>
                <TableRow>
            ...
            <Typography>No Quadro 06 você poderá visualizar os principais instrumentos e suas características, a saber: Plano de Saúde; Programação Anual de Saúde; e Relatórios de Gestão.</Typography>
