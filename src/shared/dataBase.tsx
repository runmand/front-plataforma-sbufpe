...
export const teacherTeamGI = [
  ...
  },
  {
    ...
    photo: './profile-image/DaniloAlmeida.jpg',
    contacts: [
      {
        id: 'linked-in',
        title: 'LinkedIn',
...
export const studentTeamTI = [
  {
    ...
    role: 'Estudante',
    photo: './profile-image/StephanyCarvalho.jpg',
    contacts: [
      {
        id: 'linked-in',
        title: 'LinkedIn',
  ...
  },
  {
    name: 'Antonio Netto',
    role: 'Estudante',
    photo: './profile-image/AntonioNeto.jpg',
    contacts: [
      {
        id: 'linked-in',
        title: 'LinkedIn',
  ...
  },
  {
    name: 'Igor Pereira',
    role: 'Estudante',
    photo: './profile-image/IgorPereira.jpg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
  ...
  },
  {
    ...
    role: 'Estudante',
    photo: './profile-image/NataliaNascimento.jpg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
  ...
  },
  {
    name: 'Bruno Moura',
    role: 'Estudante',
    photo: './profile-image/BrunoMoura.jpeg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
  ...
  },
  {
    ...
    role: 'Estudante',
    photo: './profile-image/MatheusAntonio.jpeg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
...
export const studentsTeamGI = [
  {
    name: 'Agna Roberta',
    role: 'Estudante',
    photo: './profile-image/AgnaRoberta.jpg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
  ...
  },
  {
    ...
    role: 'Estudante',
    photo: './profile-image/CarlosFernando.jpg',
    contacts: [
      {
        id: 'cnpq',
        title: 'CNPq',
...
export const planejaTable01 = [
  {
    title: 'Explicativo',
    description:
      'Realiza-se um diagnóstico situacional, onde os problemas são selecionados e analisados, especificando-se nós críticos (causas que explicam o problema que, quando modificadas, por si só promovem a alteração de outra ou de uma série de causas).',
  },
  {
    title: 'Normativo',
    description:
      'Construção do plano de ação/intervenção, onde são definidos o que se deseja alcançar e as respectivas estratégias.',
  },
  {
    title: 'Estratégico',
    description:
      'Análise de viabilidade das ações a serem realizadas, incluindo a análise dos recursos econômicos, administrativos e políticos necessários e/ou disponíveis a partir das propostas traçadas.',
  },
  {
...
export const planejaTable04 = [
  {
    ...
    description:
      'Etapa de contextualização crítica pelo grupo de trabalho do momento sócio-histórico local e global no qual se pretende operar o planejamento.',
  },
  {
    goal: 'Marco Doutrinal',
    description:
      'A discussão e definição dos valores, crenças e ideias gerais do coletivo, o modelo de sociedade que o grupo acredita. Os resultados consensuados destas reflexões deverão subsidiar o processo de planejamento e o próprio plano.',
  },
  {
    goal: 'Marco Operacional',
    description:
      'A tomada de decisão do grupo no sentido de construir o plano e aplicar aquilo que foi discutido.',
  },
];
...
export const planejaTable05 = [
  {
    ...
    synopsis:
      'Lei Orgânica da Saúde, que define os princípios do SUS e as atribuições dos entes federativos e estabelece o planejamento ascendente (ou seja, partindo do micro para o macro).',
  },
  {
    legalGoal: 'Lei nº 8.142, de 29 de novembro de 1990 (BRASIL, 2990b)',
    synopsis:
      'Traz a necessidade de os entes federativos disporem de plano de saúde e relatórios de gestão para fazerem jus ao recebimento de recursos financeiros.',
  },
  {
    legalGoal: 'Decreto nº 7.508, de junho de 2011 (BRASIL, 2011)',
    synopsis:
      'Regulamenta a Lei nº 8.080, dispondo de um capítulo específico sobre planejamento da saúde, o estabelecimento de metas de saúde e a necessidade de o gestor público elaborar e apresentar instrumentos de planejamento.',
  },
  {
    legalGoal: 'Lei Complementar nº 141, de janeiro de 2012 (BRASIL, 2012)',
    synopsis:
      'Regulamenta o artigo 198 da Constituição Federal de 1988, definindo normas de fiscalização, avaliação e controle das despesas com o SUS nos entes federativos, e determina o planejamento ascendente e mecanismos de financiamento do SUS.',
  },
  {
    legalGoal:
      'Portaria de Consolidação nº 1, de 28 de setembro de 2017 (Título IV do Capítulo I) (substitui a Portaria nº 2.135, de setembro de 2013) (BRASIL, 2017)',
    synopsis:
      'Estabelece diretrizes para o planejamento do SUS e define instrumentos do planejamento em saúde (Plano Municipal de Saúde, Programação Anual da Saúde, Relatório Anual de Gestão, Relatório Detalhado do Quadrimestre Anterior) e orienta pressupostos do planejamento.',
  },
];
...
export const acervo = [
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Matriz Avaliativa dos Centros de Especialização Odontologicas(CEO)',
    author: 'Observatório de Saúde Bucal - GESTBUCAL',
  ...
  },
  {
    type: 'CEO-PARAÍBA',
    article:
      'Curso Curso Virtual sobre Políticas Informadas de Evidências(PIE)',
  ...
  },
  {
    type: 'CEO-PARAÍBA',
    article:
      'Curso de Residência em Clínica Integrada em Odontologia com enfae em: Endodontia, Prótese Dentário, Cirurgia Oral Menor e Diagnóstico bucal.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Prestação de Serviços de Manutenção Predial em Estabelecimentos Assistenciais de Saúde. Ciênc. Saúde Col.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'How Has Teledentistry Been Applied in Public Dental Health Services? An Integrative Review.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Programa Nacional de Melhoria do Acesso e da Qualidade dos Centros de Especialidades Odontológicas (Pmaq-CEO): manual instrutivo 2º Ciclo (2015-2017).',
    author:
  ...
  },
  {
    ...
    author:
      'Ministério da Saúde. Fundação Oswaldo Cruz; Agência Nacional de Vigilância Sanitária.',
  ...
  },
  {
    ...
    author:
      'Ministério da Saúde. Departamento de Gestão da Educação na Saúde, Secretaria de Gestão do Trabalho e da Educação na Saúde',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Retificação na Portaria nº 718, SAS/MS de 20 de dezembro de 2010, publicada no Diário Oficial nº 251, de 31 de dezembro de 2010, seção 1, páginas 100 a 113.',
  ...
  },
  {
    ...
    article: 'A saúde bucal no Sistema Único de Saúde',
    author:
      'MINISTÉRIO DA SAÚDE - BRASIL. Secretaria de Atenção à Saúde. Departamento de Atenção Básica',
  ...
  },
  {
    ...
    author:
      'MINISTÉRIO DA SAÚDE - BRASIL. Secretaria de Atenção à Saúde. Secretaria de Vigilância em Saúde.',
  ...
  },
  {
    ...
    type: 'Avaliação CEO',
    article:
      'Avaliação de desempenho de sistemas de saúde e gerencialismo na gestão pública brasileira.',
  ...
  },
  {
    ...
    author:
      'Carrer, F. C. de almeida, Matuck, B., Lucena , E. H. G. de, Martins, F. C., Pucca Junior , G. A., Galante , M. L., Tricoli, M. F. de M., & Macedo , M. C. S. (2020).',
    link: 'http://www.cescage.com.br/revistas/index.php/JournalofHealth/article/download/1579/pdf',
  },
  {
    type: 'Avaliação CEO',
    article:
      'Política Nacional de Saúde Bucal Brasileira (Brasil Sorridente): a maior política pública de saúde bucal do mundo',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Cultura de segurança na percepção dos profissionais de saúde de hospitais públicos.',
    author: 'Carvalho, P.A.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Plano de carreira, cargos e salários: ferramenta favorável à valorização dos recursos humanos em saúde pública',
    author: 'Costa, A. C. O.',
  ...
  },
  {
    ...
    author:
      'de Moraes, I. M., Vieira, P. A., Pedreira, J. D. B. G., & Pedreira, E. N. (2022).',
    link: 'https://periodicojs.com.br/index.php/hs/article/view/673',
  },
  {
    type: 'Avaliação CEO',
    article:
      'Absenteísmo em odontologia na percepção de usuários e profissionais: discutindo acesso, equidade e bucalidade.',
    author: 'Dias TM.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Teleodontologia, formação profissional e assistência odontológica no sistema único de saúde brasileiro: relato de experiência.',
    author:
      'do Nascimento, A. D. A., de Holanda, L. A. L., Borges, B. S., Pereira, F. T., Frade, A. L., de Barros Santos, C., & de Lacerda Vidal, A. K. (2020)',
    link: 'http://www.cescage.com.br/revistas/index.php/JournalofHealth/article/view/1579',
  },
  {
    type: 'Avaliação CEO',
    article:
      'Serviços de Telessaúde como apoio à Educação Permanente na Atenção Básica à Saúde: uma proposta de modelo avaliativo. ',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Absenteísmo de usuários - barreiras e determinantes no acesso aos serviços de saúde.',
    author: 'Farias',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Gerência de serviços de saúde: competências desenvolvidas e dificuldades encontradas na atenção básica.',
  ...
  },
  {
    ...
    author:
      'Goes PSA, Figueiredo N, Neves JC Das, Silveira FM da M, Costa JFR, Pucca GA, Rosales MS.',
    link: 'https://www.scielo.br/j/csp/a/5LcWqg8q9dXtH9NQQ9yqFpK/abstract/?lang=pt',
  },
  {
    type: 'Avaliação CEO',
    article:
      'Telemedicine—A Complement to Traditional Referrals in Oral Medicine Lena.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'STUDY AND ANALYSIS OF INFORMATION TECHNOLOGY IN DENTISTRY IN LATIN AMERICAN COUNTRIES.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Sociedade de risco e risco epidemiológico. Cadernos de Saúde Pública.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Planos de cargos, carreiras e salários: perspectivas de profissionais de saúde do Centro-Oeste do Brasil.',
    author: 'Mendes, T. M. C.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Referral for secondary restorative dental care in rural and urban areas of Scotland: findings from the Highlands & Islands Teledentistry Project.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Flexibilização dos vínculos de trabalho na atenção secundária: limites da Política Nacional de Saúde Bucal.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Perdas dentárias no Brasil: análise da Pesquisa Nacional de Saúde Bucal 2010. Revista de Saúde Pública',
  ...
  },
  {
    ...
    author:
      'Raymundo ML, Freire AR, Gomes-Freire DE, Silva RO, Araújo EC, Ishigame RT, Sousa SA, Lucena EH, Cavalcanti YW.',
  ...
  },
  {
    ...
    author:
      'Righolt AJ, Walji MF, Feine JS, Williams DM, Kalenderian E, Listl S.',
  ...
  },
  {
    ...
    author:
      'Santos AS, Silveira RE, Mendonça FTNF, Buso ALZ, Silva SGF, Silva DD.',
    link: 'https://pesquisa.bvsalud.org/portal/resource/pt/bde-29084',
  },
  {
    type: 'Avaliação CEO',
    article:
      'A Web-Based Tool for Monitoring and Evaluating Health Care Services: An Analysis of Centers for Dental Specialties Webpage.',
    author:
      'Santos LX, Almeida D, Silva J, Rizental A, Goes PSA, Figueiredo N.',
    link: 'https://arquivo.revista.uepb.edu.br/index.php/pboci/article/view/3385',
  },
  {
    type: 'Avaliação CEO',
    article:
      'Interface entre a Atenção Primária e a Secundária em odontologia no Sistema Único de Saúde: uma revisão sistemática integrativa.',
    author:
      'Silva, Helbert Eustáquio Cardoso da e Gottems, Leila Bernarda Donato.',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Referência e contra referência em saúde bucal: regulação do acesso aos centros de especialidades odontológicas.',
    author: 'Souza G C',
  ...
  },
  {
    type: 'Avaliação CEO',
    article:
      'Conceptual framework for the International Classification for Patient Safety: final technical report',
    author: 'World Health Organization.',
  ...
  },
  {
    ...
    author: 'MINISTÉRIO DA SAÚDE - BRASIL. Gabinete do Ministro',
    link: 'https://bvsms.saude.gov.br/bvs/saudelegis/gm/2013/prt0529_01_04_2013.html',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Ministério da Saúde. Portaria GM/MS nº 198, de 13 de fevereiro de 2004. Institui a Política Nacional de Educação Permanente em Saúde.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Portaria GM/MS nº 1996 de 20 de agosto de 2007. Dispõe sobre as diretrizes para a implementação da Política Nacional de Educação Permanente em Saúde.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      '. A Saúde Bucal no Sistema Único de Saúde. Departamento de Atenção Básica',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://189.28.128.100/dab/docs/portaldab/publicacoes/saude_bucal_sistema_unico_saude.pdf',
  },
  {
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Portaria de Consolidação nº 6/GM/MS, de 28 de setembro de 2017, para instituir incentivo financeiro de custeio adicional mensal para municípios com equipes de saúde integradas a programas de formação profissional no âmbito da Atenção Primária à Saúde',
    author: 'BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Saúde da Família (ProfSaúde): uma experiência de formação em rede. ',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Secretaria de Atenção Primária à Saúde. Departamento de Saúde da Família. Coordenação-Geral de Provisão de Profissionais para Atenção Primária. NOTA TÉCNICA Nº 175/2020-CGPROP/DESF/SAPS/MS.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Flexibilização dos vínculos de trabalho na atenção secundária: limites da Política Nacional de Saúde Bucal. Trab. Educ. Saúde, 2016.',
    author: 'Oliveira RS, Morais HMM. ',
    link: 'https://www.scielo.br/j/tes/a/BHXYHGdMRLDsqDqBsYmf53M/abstract/?lang=pt',
  },
  {
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Secretaria de Gestão Estratégica e Participativa. Saúde, trabalho e democracia: a participação dos trabalhadores de saúde nos conselhos. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'o Programa para o Fortalecimento das Práticas de Educação Permanente em Saúde no Sistema Único de Saúde - PRO EPS-SUS.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'A Educação Permanente Entra na Roda: pólos de educação permanente em saúde - conceitos e caminhos a percorrer.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Educação Permanente na Atenção Básica à Saúde: uma proposta de modelo avaliativo. Interface - Comunicação, Saúde, Educação. ',
  ...
  },
  {
    ...
    article:
      'Teleodontologia, formação profissional e assistência odontológica no sistema único de saúde brasileiro: relato de experiência.',
    author:
      'do Nascimento, A. D. A., de Holanda, L. A. L., Borges, B. S., Pereira, F. T., Frade, A. L., de Barros Santos, C., & de Lacerda Vidal, A. K',
  ...
  },
  {
    ...
    article: 'TELEODONTOLOGY AND ORAL HEALTH: CHALLENGES AND PERSPECTIVES. ',
    author:
      'de Moraes, I. M., Vieira, P. A., Pedreira, J. D. B. G., & Pedreira, E. N.',
    link: 'https://www.periodicojs.com.br/index.php/hs/article/view/673',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Manual de Telessaúde para Atenção Básica / Atenção Primária à Saúde / Ministério da Saúde, Universidade Federal do Rio Grande do Sul.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'A Avaliação no Campo da Saúde. In: BROUSSELLE et al. Avaliação: conceitos e métodos. ',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Tipologia da estrutura das unidades básicas de saúde brasileiras: os 5 R. Cadernos de Saúde Pública, v. 33, p. e00037316, 2017',
    author: 'BOUSQUAT, Aylene et al',
    link: 'https://www.scielo.br/j/csp/a/9rx8BSNyQ5FQWvtbdKgthkx/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article: 'The quality of care. How can it be assessed?',
    author: 'DONABEDIAN A. ',
    link: 'https://pubmed.ncbi.nlm.nih.gov/3045356/',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica - 2. ed. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL. Secretaria de Atenção à Saúde',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/manual_estrutura_fisica_ubs.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'AMORIM, G.M.; QUINTÃO, E.C.V.; MARTELLI-JÚNIOR, H.; BONAN, P.R.F.',
    link: 'https://www.scielo.br/j/csc/a/MVG4bLMfvrRjvwCT4Jjpkmx/abstract/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portaria nº 2.488, de 21 de outubro de 2011. ',
    author: 'BRASIL.',
    link: 'https://bvsms.saude.gov.br/bvs/saudelegis/gm/2011/prt2488_21_10_2011.html',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Gerenciamento em Enfermagem. Rio de Janeiro, Guanabara Koogan, 2014, p.155-167.',
    author: 'CASTILHO, V.; GONÇALVES, V. L. M.',
    link: 'https://repositorio.usp.br/item/002143939',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Qualidade e subjetividade na avaliação de programas e serviços em saúde. Cad Saúde Pública',
    author: 'Uchimura KY, Bosi MLM.',
    link: 'https://www.scielo.br/j/csp/a/jsNy8jWBKbwmggFQM6t5DHQ/#:~:text=Trata%2Dse%20de%20uma%20constru%C3%A7%C3%A3o,estreita%20imbrica%C3%A7%C3%A3o%20com%20a%20subjetividade.',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portaria nº 2.488, de 21 de outubro de 2011.',
  ...
  {
    type: 'Avaliação da APS',
    article: 'Portaria nº 2.436, de 21 de setembro de 2017.',
    author: 'BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/saudelegis/gm/2017/prt2436_22_09_2017.html',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portaria nº 2.226, de 18 de setembro de 2009',
    author: 'BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/saudelegis/gm/2009/prt2226_18_09_2009_rep.html',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Avaliação da qualidade da atenção primária pelos profissionais de saúde: comparação entre diferentes tipos de serviços. Cad Saúde Pública. ',
    author: 'CASTRO RCL, KNAUTH DR, HARZHEIM E, HAUSER L, DUNCAN BB.',
    link: 'https://www.scielosp.org/article/csp/2012.v28n9/1772-1784/',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author:
      'FERNANDES MC, BARROS AS, SILVA LMS, NÓBREGA MFB, SILVA MRF, TORRES RAU. ',
    link: 'https://www.redalyc.org/pdf/2670/267019595002.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author:
      'MOURA BLA, CUNHA RC, FONSECA ACF, AQUINO R, MEDINA MG, VILASBÔAS ALQ et al. ',
    link: 'https://www.scielo.br/j/rbsmi/a/h9yDHjsSmPx3pxVCxr3LbnR/abstract/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'NIQUINI RP, BITTENCOURT SA, LACERDA EMA, SAUNDERS C, LEAL MC. ',
    link: 'https://bvssp.icict.fiocruz.br/pdf/25833_niquinirpm.pdf',
  },
  {
    type: 'Avaliação da APS',
    article: 'Manual de gerenciamento de resíduos de serviços de saúde.',
    author: 'BRASIL',
    link: 'http://antigo.anvisa.gov.br/resultado-de-busca?p_p_id=101&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_101_struts_action=%2Fasset_publisher%2Fview_content&_101_assetEntryId=271316&_101_type=document&redirect=http%3A%2F%2Fantigo.anvisa.gov.br%2Fresultado-de-busca%3Fp_p_id%3D3%26p_p_lifecycle%3D0%26p_p_state%3Dnormal%26p_p_mode%3Dview%26p_p_col_id%3Dcolumn-1%26p_p_col_count%3D1%26_3_groupId%3D0%26_3_keywords%3DManual%2Bde%2Bgerenciamento%2Bde%2Bres%25C3%25ADduos%2Bde%2Bservi%25C3%25A7o%2Bde%2Bsa%25C3%25BAde%26_3_cur%3D1%26_3_struts_action%3D%252Fsearch%252Fsearch%26_3_format%3D%26_3_formDate%3D1441824476958%20',
  },
  {
    type: 'Avaliação da APS',
    article:
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Agência Nacional de Vigilância Sanitária. Documento de Referência para o Programa Nacional de Segurança do Paciente.',
    author: 'BRASIL',
    link: 'http://bvsms.saude.gov.br/bvs/publicacoes/documento_referencia_programa_nacional_seguranca.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Cultura de segurança na percepção dos profissionais de saúde de hospitais públicos',
    author: 'Carvalho, P.A.',
    link: 'https://www.scielo.br/j/rsp/a/vxrzhVhFgGTZJ7pWksphpWj/?format=pdf&lang=pt#:~:text=Em%20estudo%20realizado%20em%20tr%C3%AAs,que%20obteve%20a%20melhor%20avalia%C3%A7%C3%A3o9.',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Sociedade de risco e risco epidemiológico. Cadernos de Saúde Pública, Rio de Janeiro',
    author: 'Luiz O.C., Cohn A. ',
    link: 'https://www.scielo.br/j/csp/a/86Wndmt9FFbB4SQmCmtMVkm/abstract/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Conceptual framework for the International Classification for Patient Safety: final technical report. Version 1.1. Geneva (CH): WHO; 2009',
    author: 'World Health Organization',
    link: 'https://www.who.int/patientsafety/taxonomy/icps_full_report.pdf',
  },
  {
    ...
    author: 'TEIXEIRA CS.',
    link: 'https://pesquisa.bvsalud.org/odontologia/resource/espt/lil-487775',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Manual de estrutura física das unidades básicas de saúde: saúde da família / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/manual_estrutura_fisica_ubs.pdf',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portal da Secretaria de Atenção Primária à Saúde',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: '',
  },
  {
    type: 'Avaliação da APS',
    article: 'PORTARIA Nº 2.983, DE 11 DE NOVEMBRO DE 2019. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://aps.saude.gov.br/ape/informatizaaps/oqueprotunario',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Estratégia de Saúde Digital para o Brasil 2020-2028 [recurso eletrônico] ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/estrategia_saude_digital_Brasil.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author:
      'Santos LX, Almeida D, Silva J, Rizental A, Goes PSA, Figueiredo N. ',
    link: 'https://docs.bvsalud.org/biblioref/2018/12/966856/55.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'Almeida DR de S; Santos LX; Figueiredo N. ',
    link: 'http://periodicos.ufc.br/resdite/article/view/44528/196841',
  },
  {
    type: 'Avaliação da APS',
    article: 'Primary and secondary dental care: how ideal is the interface?',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Yogesh Pawar Evaluation of Applications Operated by Dentists. International Journal of Scientific & Engineering Research',
    author: 'Priya Sinha, Kavita Singh.',
    link: 'https://www.ijser.org/researchpaper/Evaluation-of-Applications-Operated-by-Dentists.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Referral for secondary restorative dental care in rural and urban areas of Scotland: findings from the Highlands & Islands Teledentistry Project. ',
    author: 'NUTTALL NM, STEED MS, DONACHIE MA.',
    link: 'https://www.researchgate.net/publication/11433138_Referral_for_secondary_restorative_dental_care_in_rural_and_urban_areas_of_Scotland_Findings_from_the_Highlands_Islands_Teledentistry_Project',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portaria nº 2.983, de 11 de novembro de 2019.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://brasilsus.com.br/wp-content/uploads/2019/11/portaria2983.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Impactos da implantação do prontuário eletrônico do paciente sobre o trabalho dos profissionais de saúde da Prefeitura Municipal de Belo Horizonte. ',
    author: 'MOURÃO, A. D.; NEVES, J. T. R',
    link: 'https://www.aedb.br/seget/arquivos/artigos07/56_SEGET.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'O prontuário eletrônico do paciente no sistema de saúde brasileiro. ',
    author: 'PATRÍCIO, C. M.; MAIA, M. M.; MACHIAVELLI, J. L.; NAVAES, M. A.',
    link: 'https://revistaseletronicas.pucrs.br/ojs/index.php/scientiamedica/article/view/8723/6722',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'PEREZ, G.; ZWICKER, R.',
    link: 'https://www.scielo.br/j/ram/a/Zv7szN5pPGHWq4zXDF9Wqwx/abstract/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Qualidade de dados em registro de Atenção Primária à Saúde [recursos eletrônicos]: curso para enfermeiros, médicos e odontólogos.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://telessaude.hc.ufmg.br/curso-qualidade-de-dados-em-registro-de-atencao-primaria-a-saude-aps/',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Educação em saúde na atenção básica: sujeito, diálogo, intersubjetividade.',
    author: 'DANTAS, Maria Beatriz Pragana et al.',
    link: 'https://www.arca.fiocruz.br/handle/icict/10508',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Programa de Saúde da Família. Brasília, DF: Coordenação de Saúde da Comunidade, Secretaria de Assistência à Saúde, 1997.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/cd09_16.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://bvsms.saude.gov.br/bvs/saudelegis/gm/2011/prt2488_21_10_2011.html',
  },
  {
    type: 'Avaliação da APS',
    article:
      'O território da saúde: a organização do sistema de saúde e a territorialização. Território, ambiente e saúde.',
    author: 'GONDIM, Grácia Maria de Miranda et al.',
    link: 'Microsoft Word - 15_Gondim et0 al.doc (escoladesaude.pr.gov.br)',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Planejamento na Atenção Básica. Florianópolis : Universidade Federal de Santa Catarina, 2012.',
    author:
      'LACERDA, Josimari Telino de; BOTELHO, Lúcio José; COLUSSI, Cláudia Flemming.',
    link: 'https://ares.unasus.gov.br/acervo/handle/ARES/1167',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'NÚCLEO DE TELESSAÚDE SANTA CATARINA',
    link: 'Qual o objetivo e como elaborar o mapa do território adscrito pela equipe de saúde da família no contexto da Atenção Básica? - BVS Atenção Primária em Saúde',
  },
  {
    type: 'Avaliação da APS',
    article:
      'A saúde bucal no Sistema Único de Saúde [recurso eletrônico] / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Guia Política Nacional de Atenção Básica - Módulo 1 : Integração Atenção Básica e Vigilância em Saúde [recurso eletrônico] ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/guia_politica_nacional_atencao_basica_integracao_atencao_basica_vigilancia_saude_modulo_1.pdf',
  },
  {
    type: 'Avaliação da APS',
    article: 'A Segurança do Hospital no Conforto do seu Lar',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://189.28.128.100/dab/docs/geral/CAD_VOL2_CAP2.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      '. Portaria GM de nº 2.488 de 21 de outubro de 2011. Aprova a Política Nacional de Atenção Básica, estabelecendo a revisão de diretrizes e normas para a organização da Atenção Básica, para a Estratégia Saúde da Família (ESF) e o Programa de Agentes Comunitários de Saúde (PACS)',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://bvsms.saude.gov.br/bvs/saudelegis/gm/2011/prt2488_21_10_2011.html',
  },
  {
    ...
    author:
      'BRITO, L. N. S.; LUCAS, R. C. C.; ANDRADE, F. F.; SOUSA, Y. A. B.; LUCAS, R. S. de C. C.; MADRUGA, R. R. C.; SOARES, G. B.',
    link: 'https://revabeno.emnuvens.com.br/revabeno/article/view/1096',
  },
  {
    type: 'Avaliação da APS',
    article: 'Saúde bucal por ciclos de vida',
    author: 'FIO CRUZ',
    link: null,
  },
  {
    type: 'Avaliação da APS',
    article:
      'ODONTOLOGIA E PSE: estreitando laços e ampliando as ações coletivas de saúde bucal no município de Porto Seguro.',
    author: 'FALABRETTI; SANTOS.',
    link: 'https://www.cosemsba.org.br/wp-content/uploads/2016/06/odontologia_e_pse.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Caderno temático do Programa Saúde na Escola: saúde bucal [recurso eletrônico] / Ministério da Saúde, Ministério da Educação.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/caderno_tematico_pse_saude_bucal.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Saúde da Família: uma estratégia para a reorientação do modelo assistencial. Brasília: Ministério da Saúde. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://bvsms.saude.gov.br/bvs/publicacoes/cd09_16.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Guia Política Nacional de Atenção Básica – Módulo 1 : Integração Atenção Básica e Vigilância em Saúde [recurso eletrônico',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'guia_politica_nacional_atencao_basica_integracao_atencao_basica_vigilancia_saude_modulo_1.pdf',
  },
  {
    type: 'Avaliação da APS',
    article: 'Protocolo de Atenção Domiciliar em Saúde Bucal',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'protocolo_atencao_domiciliar_saude_bucal-18-3-2019.indd (pbh.gov.br)',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Departamento de Atenção Básica. - Brasília : Ministério da Saúde, 2008. 92 p. - (Série A. Normas e Manuais Técnicos)',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      '. Departamento de Atenção Básica. A saúde bucal no Sistema Único de Saúde [recurso eletrônico] / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf',
  },
  {
    ...
    author: 'BIZERRIL, Davi Oliveira et al. ',
    link: 'https://rbmfc.emnuvens.com.br/rbmfc/article/view/1020',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Atuação da equipe de saúde bucal na atenção domiciliar na Estratégia Saúde da Família: uma revisão integrativa.',
    author:
      'Silva, Renata Marques da, Peres, Ana Carolina Oliveira e Carcereri, Daniela Lemos',
    link: 'https://doi.org/10.1590/1413-81232020256.15992018',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'Ministério da Saúde (saude.gov.br)',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Departamento de Saúde da Família. Coordenação-Geral de Saúde Bucal. SB BRASIL 2020: PESQUISA NACIONAL DE SAÚDE BUCAL, 2021. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/pesquisa_nacional_saude_bucal.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Secretaria de Atenção Primária à Saúde. SB Brasil 2020 (vigência 2021-2022)',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'Portal da Secretaria de Atenção Primária a Saúde (saude.gov.br)',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Levantamentos epidemiológicos em saúde bucal: análise metodológica proposta pela Organização Mundial da Saúde.',
    author: 'OLIVEIRA AGRC, et al.',
    link: 'http://www.scielo.br/pdf/rbepid/v1n2/08.pdf Acesso em: 7 de mar. de 2022.',
  },
  {
    type: 'Avaliação da APS',
    article:
    ...
    author: 'SILVA, Manoelito Ferreira Silva et al.',
    link: 'https://revabeno.emnuvens.com.br/revabeno/article/view/1133 (emnuvens.com.br)',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Desafios da Atenção primária à Saúde no Brasil: Módulo do Curso Qualifica APS. Porto Alegre: TelessaúdeRS/ UFRGS, 2016.',
    author: 'TELESSAÚDERS-UFRGS',
    link: null,
  },
  {
    type: 'Avaliação da APS',
    ...
    link: 'https://www.saude.go.gov.br/images/imagens_migradas/uploads/2017/07/manual-oficina-3-territorializacao.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      '. Secretaria de Atenção à Saúde. Departamento de Atenção Básica. Saúde Bucal / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica. - Brasília : Ministério da Saúde, 2008.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal.pdf ',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Secretaria de Atenção à Saúde. Departamento de Atenção Básica. A saúde bucal no Sistema Único de Saúde [recurso eletrônico] / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf',
  },
  {
    ...
    author: 'TAVARES, Roseli Pereira et al. ',
    link: 'https://www.scielo.br/j/sdeb/a/4zxMzZrKKrHXcpf6dbj4Mcb/?format=pdf&lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Diretrizes da Política Nacional de Saúde Bucal. Coordenação Geral de Saúde Bucal. 2004.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/politica_nacional_brasil_sorridente.htm',
  },
  {
    type: 'Avaliação da APS',
    article:
      '. Secretaria de Atenção à Saúde. Departamento de Atenção Básica. A saúde bucal no Sistema Único de Saúde [recurso eletrônico] /',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf ',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica.  Brasília : Ministério da Saúde, 2018.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf ',
  },
  {
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Secretaria de Atenção à Saúde. Departamento de Atenção Básica. Saúde Bucal / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal.pdf ',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Classificação de risco de urgências odontológicas: uma proposta de reorganização do processo de trabalho. Comunidade de práticas, 2014.',
    author: 'MATSUURA, E. ',
    link: 'https://repositorio.ufmg.br/bitstream/1843/BUBD-A45GHS/1/tcc_para_impress_o_final.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Atenção à demanda espontânea na APS / Ministério da Saúde, Secretaria de Atenção à Saúde, Departamento de Atenção Básica. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: null,
  },
  {
    type: 'Avaliação da APS',
    article:
      'Redes de atenção à saúde: rede de urgência e emergência - RUE/Marcos Antônio Barbosa Pacheco (Org.). ',
    author: 'UNIVERSIDADE FEDERAL DO MARANHÃO. UNA-SUS/UFMA',
    link: 'https://ares.unasus.gov.br/acervo/html/ARES/2435/1/UNIDADE_4.pdf ',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Challenges of the group process in team meetings on Family health strategy. Esc Anna Nery [Internet]. ',
    author: "GRANDO MK, DALL'AGNOL CM. ",
    link: 'http://www.scielo.br/pdf/ean/v14n3/v14n3a11',
  },
  {
    type: 'Avaliação da APS',
    article:
      'A Saúde Bucal no Sistema Único de Saúde. Departamento de Atenção Básica. Brasília, Distrito Federal, 2018.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/saude_bucal_sistema_unico_saude.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Reuniões da estratégia saúde da família: um dispositivo indispensável para o planejamento local. ',
  ...
  },
  {
    ...
    article:
      'Política Nacional de Saúde Bucal Brasileira (Brasil Sorridente): a maior política pública de saúde bucal do mundo.',
    author: 'CARRER, Fernanda Campos de Almeida et al.',
    link: 'https://pesquisa.bvsalud.org/portal/resource/pt/biblio-994756',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Departamento de Atenção Básica. Programa Nacional de Melhoria do Acesso e da Qualidade dos Centros de Especialidades Odontológicas',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'http://189.28.128.100/dab/docs/portaldab/publicacoes/manual_pmaqceo_preliminar.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'A Importância das Ações de Gestão na Organização do Trabalho nos CEO.',
    author:
      'SILVA, Andrea Neiva da; Zina, Lívia Guimarães; Silva, Marcos Alex Mendes da; Werneck, Marcos Azeredo Furquim, et. al.',
    link: 'https://www.researchgate.net/publication/317600996_A_Importancia_das_Acoes_de_Gestao_na_Organizacao_do_Trabalho_nos_CEO',
  },
  {
    type: 'Avaliação da APS',
    article: 'HumanizaSUS: equipes de referência e apoio matricial.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/equipe_referencia.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Núcleo de Apoio a Saúde da Família. Brasília: Editora do Ministério da Saúde; 2009. ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/caderno_atencao_basica_diretrizes_nasf.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Os caminhos da saúde bucal no Brasil: um olhar quali e quanti sobre os Centros de Especialidades Odontológicas (CEO) no Brasil. Recife: Editora da UFPE',
    author: 'FIGUEIREDO, N.; GOES, PSA de; MARTELLI, P',
    link: 'https://www.ufpe.br/documents/1181966/0/Livro_Os+caminhos+da+sa%C3%BAde+bucal+no+Brasil+_+PMAQ-CEO.pdf/f06f06e7-4fc7-47cd-acb9-e864e8ea9dc7',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Caderno do Curso Apoio Matricial na Atenção Básica com Ênfase nos Nasf: aperfeiçoamento. ',
    author: 'MELO, Eduardo Alves (Org.) ',
    link: 'https://pesquisa.bvsalud.org/bvsms/resource/pt/mis-38006',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Diretrizes Nacionais da Vigilância em Saúde / Ministério da Saúde, Secretaria de Vigilância em Saúde, Secretaria de Atenção à Saúde.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Apoio matricial em saúde mental entre CAPS e Saúde da Família: trilhando caminhos possíveis. ',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Princípios do Apoio Matricial. In: Gusso e Lopes (Org.). Tratado de Medicina de Família e Comunidade. ',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Making the best use of consultant orthodontic services. Part 1: Determining which patients require referral.',
    author: 'FERGUSON JW; LANGFORD JW; DAVENPORT PJ.',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Primary and secondary dental care: how ideal is the the interface?',
    author: 'Morris AJ, Burke FJT',
    link: 'https://pubmed.ncbi.nlm.nih.gov/11792112/',
  },
  {
    type: 'Avaliação da APS',
    article:
      'The British Society of Periodontology referral policy and parameters of care. ',
    author: 'DOWELL P, CHAPPLE IL.',
    link: 'https://pubmed.ncbi.nlm.nih.gov/12369309/',
  },
  {
    type: 'Avaliação da APS',
    article:
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Ministério da Saúde, Universidade Federal do Rio Grande do Sul - Brasília: Ministério da Saúde',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/protocolos_atencao_basica_especializada_cardiologia_v_II.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Atributos da Atenção Primária: como realizar a coordenação do cuidado? ',
    author: 'BERGALLO, Renato. ',
    link: 'https://pebmed.com.br/atributos-da-atencao-primaria-como-realizar-a-coordenacao-do-cuidado/',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Cardiologia [recurso eletrônico] / Ministério da Saúde, Universidade Federal do Rio Grande do Sul ',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/protocolos_atencao_basica_especializada_cardiologia_v_II.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Referência e contrarreferência em saúde bucal: regulação do acesso aos centros de especialidades odontológicas.',
    author: 'SOUZA, Georgia C et al . ',
    link: 'https://doi.org/10.15446/rsap.v17n3.44305',
  },
  {
    type: 'Avaliação da APS',
    article: 'Diretrizes da política nacional de saúde bucal. Brasília, 2004',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/publicacoes/politica_nacional_brasil_sorridente.htm',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Atenção Primária e promoção da saúde: Coleção Progestores – Para entender a gestão do SUS. ',
    author: 'CONASS. Conselho Nacional de Secretários da Saúde-CONASS',
    link: 'http://www6.ensp.fiocruz.br/visa/?q=node/4914',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Departamento de Medicina Social (DMS) B Centro de Informação e Informática em Saúde (CIIS)',
    author:
      'FERREIRA, Janise. Saúde & Gestão Faculdade de Medicina de Ribeirão Preto (FMRP)',
    link: 'https://pt.scribd.com/document/520237685/Boletim-Saude-e-Gestao-Indicadores-Previne-Brasil',
  },
  {
    type: 'Avaliação da APS',
    article: 'Avaliação, Monitoramento e Melhoria da Qualidade na APS',
    author:
      'TOMASI, Elaine; NEDEL, Fúlvio Borges; BARBOSA, Allan Claudius Queiroz.',
    link: 'https://apsemrevista.org/aps/article/view/208/100',
  },
  {
    type: 'Avaliação da APS',
    article: 'Avaliação: conceitos e métodos. Rio de Janeiro: Editora Fiocruz',
    author:
      'BROUSSELLE, Astrid; CHAMPAGNE, François; CONTANDRIOPOULOS, André Pierre; HARTZ, Zulmira.',
    link: 'https://portal.fiocruz.br/livro/avaliacao-conceitos-e-metodos',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Avaliação em saúde: dos modelos teóricos à prática na avaliação de programas e sistemas de saúde ',
    author: 'Hartz, Zulmira Maria de Araújo; Silva, Ligia Maria Vieira da.',
    link: 'https://books.scielo.org/id/xzdnf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Departamento de Medicina Social (DMS) B Centro de Informação e Informática em Saúde (CIIS)',
    author:
      'FERREIRA, Janise. Saúde & Gestão Faculdade de Medicina de Ribeirão Preto',
    link: 'https://pt.scribd.com/document/520237685/Boletim-Saude-e-Gestao-Indicadores-Previne-Brasil',
  },
  {
    type: 'Avaliação da APS',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Monitoramento e avaliação: reflexos visíveis na atenção primária à saúde no Brasil. ',
    author: 'AQUINO R, MEDINA MG, ABDON C. ',
    link: 'https://pesquisa.bvsalud.org/bvsms/resource/pt/mis-37950',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Dispõe sobre a revisão de diretrizes e normas para a organização da Atenção Básica para o Programa da Saúde da Família (PSF) e o Programa de Agentes Comunitários de Saúde (PACS).',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://www.nescon.medicina.ufmg.br/biblioteca/imagem/1837.pdf',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Gestão pública em saúde: monitoramento e avaliação no planejamento do SUS. ',
    author: 'OLIVEIRA, A. E. F.; REIS, R. S. ',
    link: 'https://ares.unasus.gov.br/acervo/handle/ARES/7408',
  },
  {
    type: 'Avaliação da APS',
    article:
      'Trabalho em equipe: um desafio para a consolidação da estratégia de saúde da família. ',
    author: 'ARAUJO, Marize Barros de Souza; ROCHA, Paulo de Medeiros.',
    link: 'https://www.scielo.br/j/csc/a/vgK3yjGm6fBBxnXj6XZHzzq/abstract/?lang=pt',
  },
  {
    type: 'Avaliação da APS',
    article: 'Portaria 2.488 de 11 de outubro de 2011.',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
    link: 'https://bvsms.saude.gov.br/bvs/saudelegis/gm/2011/prt2488_21_10_2011.html',
  },
  {
  ...
  },
  {
    ...
    author: 'CARDOSO CG, HENNINGTON EA',
    link: 'https://www.researchgate.net/publication/262502481_Multidisciplinary_meetings_the_health_team_work_in_construction_and_waiting_for_the_subjects_of_change',
  },
  {
    type: 'Avaliação da APS',
    article:
      'A importância da comunicação entre as equipes de saúde e usuários: a busca da qualidade no atendimento. 2019.',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Comunicação entre profissional de saúde e paciente: percepções de mulheres com câncer de mama.',
    author: 'OTANI, M.A.P',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Comunicação nas práticas em saúde: revisão integrativa da literatura.',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Educação em saúde: programa e canal de comunicação via WhatsApp da unidade básica de saúde do N6 para comunidade rural do sertão pernambucano.',
    author:
      'JÚNIOR, Aristóteles Homero dos Santos Cardona; DE QUEIROZ ANDRADE, Cleusa Wanderley; CALDAS, Luciana Nogueira Mendes',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Avaliação dos usuários sobre o Programa de Saúde da Família em Vitória da Conquista - Bahia',
    author: 'TEIXEIRA SA',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'O Portal CEO: um experimento em saúde digital à gestão dos Centros de Especialidades Odontológicas',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Saúde bucal no Programa Saúde da Família: uma avaliação do modelo assistencial.',
  ...
  },
  {
    type: 'Avaliação da APS',
    article:
      'Reunião de equipe: uma reflexão sobre sua importância enquanto estratégia diferencial na gestão coletiva no Programa de Saúde da Família (PSF).',
    author:
      'CRUZ MLS, FRANCO L, CARVALHO JW, SILVA FB, BETELI VC, LIMA MF et al.',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Planejamento participativo realizado em área de abrangência do programa saúde da família. Revista APS',
    author:
      'GABRIEL AGUIAR, GIZELE FAGUNDES, KEILA LEÃO, PEDRO ALMEIDA, MILENA DE SOUZA',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Processo decisório: a tomada de decisão. Revista Científica Eletrônica de Agronomia, v. 20, n. 1, 2011',
    author:
      'CRISTINA BERTONCINI, ADRIANA BRITO, ELISANGELA LEME, ISMAEL SILVA, THIAGO SILVA, RICARDO PERRI',
    link: 'https://faef.revista.inf.br/imagens_arquivos/arquivos_destaque/QjxDDqGcS5r3dHL_2013-5-3-12-8-34.pdf',
  },
  {
    type: 'Planeja SD',
    article:
      'Regulamenta a Lei nº 8.080, de 19 de setembro de 1990, para dispor sobre a organização do Sistema Único de Saúde - SUS, o planejamento da saúde, a assistência à saúde e a articulação interfederativa, e dá outras providências. 2011',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'LEI COMPLEMENTAR Nº 141, DE 13 DE JANEIRO DE 2012 QUE REGULAMENTA O §3º DO ART. 198',
    author: 'PRESIDÊNCIA DA REPÚBLICA - BRASIL',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Portaria de Consolidação nº 1, de 28 de setembro de 2017. Consolidação das Normas sobre os direitos e deveres dos usuários da saúde, a organização e o funcionamento do Sistema Único de Saúde (Título IV, Capítulo I). 2017',
    author: 'MINISTÉRIO DA SAÚDE - BRASIL',
  ...
  },
  {
    ...
    author:
      'Camargo, F. C., Machado, G. G., Felipe, L. R. R., Faria, G. S., Nogueira, A. L., Reis, S. C. R. M., & Walsh, I. A. P.,',
    link: 'https://seer.uftm.edu.br/revistaeletronica/index.php/refacs/article/view/4528/pdf',
  },
  {
    type: 'Planeja SD',
    article:
      '. Planejamento e programação em saúde – texto para fixação de conteúdos e seminários. ',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Gestão participativa na Estratégia Saúde da Família: reorientação da demanda à luz do Método Paideia',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Concepções, estratégias e usos do planejamento na gerência em Unidades de Saúde da Família',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'A prática do planejamento participativo. 11. ed. Petrópolis: Vozes, 2002.',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Reflexões sobre o planejamento em saúde e o processo da reforma sanitária brasileira',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Política, planejamento e governo. Brasília: Instituto de Pesquisa Econômica Aplicada, 1993',
    author: 'CARLOS MATUS',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Planejamento em saúde para não especialistas. In: CAMPO, et al. Tratado de saúde coletiva. ',
    author: 'JAIRNILSON PAIM',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Planejamento Estratégico Situacional - PES: uma análise bibliométrica da produção científica brasileira',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      '. Planejamento em Saúde. Método Altair de Planificação Popular - MAPP',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Planejamento em saúde. São Paulo: Faculdade de Saúde Pública da Universidade de São Paulo',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Which criteria are considered in healthcare decisions? Insights from an international survey of policy and clinical decision makers. International Journal of Technology Assessment in Health Care',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'Planejamento, gestão e avaliação em saúde bucal. São Paulo: Artes Médicas',
  ...
  },
  {
    type: 'Planeja SD',
    article:
      'District decisionmaking for health in low income settings: a systematic literature review. Health Policy and Planning',
  ...
  },
  {
    ...
    author:
      'M. COMASSETTO, A. BAUMGARTEN, K. KINDLEIN, J. HILGERT, M. FIGUEIREDO, D. FAUSTINO-SILVA',
  ...
  },
  {
    ...
    author:
      'MINISTÉRIO DA SAÚDE SECRETARIA DE POLÍTICAS DE SAÚDE DEPARTAMENTO DE ATENÇÃO BÁSICA ÁREA TÉCNICA DE SAÚDE BUCAL',
  ...
  },
  {
    ...
    author:
      'J. ANTUNES, T. TOPORCOV, J. BASTOS, P. FRAZÃO, P. NARVAI, M. PERES',
  ...
  },
  {
    ...
    author:
      'F. HUGO, J. BAILEY, C. STEIN, A. CUNHA, B. ISER, D. MALTA, J. GIORDANI, J. HILGERT, L. ABREU, N. KASSEBAUM',
  ...
  },
  {
    ...
    author:
      'R. B. CORASSA, C. J. DE PAULA SILVA, J. S. DE PAULA, É. C. DE AQUINO, L. M. V. SARDINHA, P. A. B. ALVES',
  ...
  },
  {
    ...
    article:
      'Avaliação da satisfação do usuário no serviço de saúde bucal: revisão integrativa da literatura',
  ...
  },
  {
    type: 'Satisfação do Usuário',
    article:
      'GestBucalSD: Avaliação da Satisfação do Usuário em Saúde Bucal por plataforma digital.',
    author:
      'W. COSTA, N. FIGUEIREDO, V. COSTA, A. CHAVES, G. NASCIMENTO, R. GUIMARÃES',
    ...
    menuItemChildren: [
      {
        ...
        title: 'Filho 11',
        url: '/AnswerForm',
        menuItemChildren: [{ id: 111, title: 'Neto 111', url: '/AnswerForm' }],
      },
