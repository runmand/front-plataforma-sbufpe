...
export default function Page() {
    ...
    const [stepsValues, setStepsValues] = useState<IStepsValues>({
        ...
        thirdStep: {
            causas: [
                { id: 1, causa: '', explicacao: '' },
                { id: 2, causa: '', explicacao: '' },
                { id: 3, causa: '', explicacao: '' },
                { id: 4, causa: '', explicacao: '' },
            ],
        },
        fourthStep: {
            mentalMapUrl: '',
    ...
    useEffect(() => {
        document.title = 'Planeja Prático | GestBucal';
    }, []);
    ...
    useEffect(() => {
        if (!next) {
            if (stepsValues.firstStep[0].domain == '') {
                ...
                setActiveIndex(2);
            } else if (stepsValues.thirdStep.causas.every((causa) => causa.causa === '')) {
                setActiveIndex(3);
            ...
            mainContainerChild={
                ...
                >
                    ...
                    <Paper elevation={1} sx={{ p: 3, my: 2, width: '100%' }}>
                        <Box width={'100%'} height={'100%'} my={4} display="flex" flexDirection={'column'} gap={4} color={'black'}>
                            {activeIndex === 0 && <Welcome onClickNextQuestion={nextQuestion} />}
                            {activeIndex === 1 && (
                                <FirstStep
                            ...
                            {activeIndex === 5 && <FinishFormStep stepValues={stepsValues} onClickPrevStep={previusQuestion} />}
                        </Box>
                    </Paper>
                </Box>
            }
