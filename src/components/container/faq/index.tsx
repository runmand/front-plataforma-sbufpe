...
const imagesDados = [
  {
    label: 'Dados dos Usuários',
    imgPath: 'https://i.imgur.com/XKmoaav.png',
  },
  {
    label: 'Dados CEO',
    imgPath: 'https://i.imgur.com/R0iujA5.png'
  },
  {
    label: 'Dados APS',
    imgPath: 'https://i.imgur.com/kUufyTd.png',
  },
]
    ...
    <>
      ...
      <Box sx={{
        ...
        <Typography
          ...
          color={theme.white}
        >
          8. Onde posso conferir os dados obtidos pela plataforma?
        </Typography>
      </Box>
      <Box sx={{
        position: 'justify',
        ...
        <Typography
          ...
          color={theme.black}
        >
          Cliclando em Nossos Dados SD na parte superior você pode ver os dados obtidos através da plataforma, escolha qual das 3 planilhas de resultados você quer ver, clique e acesse.
        </Typography>
        <Grid
          container
          justifyContent='center'
        ...
        >
          ...
          <Grid item xs>
            <CardMedia
              component="img"
              image="https://i.imgur.com/xjgaE4D.png"
              alt="Botão de Nossos Dados SD"
              sx={{
                width: '100%',
              }}
            />
        ...
        <Typography
          ...
          color={theme.black}
        >
          Usando o menu de filtragem na parte superior você poderá filtrar para obter apenas as informações que são necessárias a você.
        </Typography>
        <CardMedia
                component="img"
                image='https://i.imgur.com/zmFacNc.png'
