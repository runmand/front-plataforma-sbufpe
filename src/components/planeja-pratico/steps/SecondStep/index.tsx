  ...
  return (
    <form onSubmit={handleSubmit}>
        ...
        {values.defined_problems.map((item, index) => (
          <Box key={item.id} width={"100%"}>
            <InputLabel id="second_domain">
              Descreva claramente o problema identificado que será abordado na intervenção:
            </InputLabel>
            <TextField
              fullWidth
              value={item.answer}
      ...
      <Typography fontWeight={500} fontSize={16}>
        ...
        Estes PA-SB podem ser reunidos depois, formando um programa de intervenção local!
