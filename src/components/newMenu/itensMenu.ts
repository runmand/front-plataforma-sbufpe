...
export const itemsMenu: itemsListType[] = [
    ...
    { position: 6, title: "Nossos dados", subList: [{ position: 1, title: "Dashboards", route: routerEnum.DASHBOARD }, { position: 2, title: "Usuários", route: routerEnum.USER }, { position: 3, title: "CEO", route: routerEnum.CEO }, { position: 4, title: "APS", route: routerEnum.APS }, { position: 5, title: "Vigia SD (novo)", route: routerEnum.DASHBOARD_VIGIA }, { position: 6, title: "CEO (novo)", route: routerEnum.DASHBOARD_CEO }] },
];
