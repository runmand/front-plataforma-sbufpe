...
export const itemsMenu: itemsListType[] = [
    ...
    { position: 6, title: "Nossos dados", subList: [{ position: 1, title: "Usuários", route: routerEnum.USER }, { position: 2, title: "CEO", route: routerEnum.CEO }, { position: 3, title: "APS", route: routerEnum.APS }] },
];
